...
public class BlackStoneTrees1Structures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<BlackStoneTrees1Structures> CODEC = RecordCodecBuilder.<BlackStoneTrees1Structures>mapCodec(instance ->
            instance.group(BlackStoneTrees1Structures.settingsCodec(instance),
            ...
            ).apply(instance, BlackStoneTrees1Structures::new)).codec();
    ...
    public BlackStoneTrees1Structures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!BlackStoneTrees1Structures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.BLACK_STONE_BRICK1_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
