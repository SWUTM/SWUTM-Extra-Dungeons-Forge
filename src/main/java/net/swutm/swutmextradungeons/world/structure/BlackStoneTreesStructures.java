...
public class BlackStoneTreesStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<BlackStoneTreesStructures> CODEC = RecordCodecBuilder.<BlackStoneTreesStructures>mapCodec(instance ->
            instance.group(BlackStoneTreesStructures.settingsCodec(instance),
            ...
            ).apply(instance, BlackStoneTreesStructures::new)).codec();
    ...
    public BlackStoneTreesStructures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!BlackStoneTreesStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.BLACK_STONE_BRICK_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
