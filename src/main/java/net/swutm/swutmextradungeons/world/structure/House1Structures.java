...
public class House1Structures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<House1Structures> CODEC = RecordCodecBuilder.<House1Structures>mapCodec(instance ->
            instance.group(House1Structures.settingsCodec(instance),
            ...
            ).apply(instance, House1Structures::new)).codec();
    ...
    public House1Structures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!House1Structures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.HOUSE1_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
