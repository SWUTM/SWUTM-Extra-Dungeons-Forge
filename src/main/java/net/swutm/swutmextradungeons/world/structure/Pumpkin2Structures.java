...
public class Pumpkin2Structures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<Pumpkin2Structures> CODEC = RecordCodecBuilder.<Pumpkin2Structures>mapCodec(instance ->
            instance.group(Pumpkin2Structures.settingsCodec(instance),
            ...
            ).apply(instance, Pumpkin2Structures::new)).codec();
    ...
    public Pumpkin2Structures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!Pumpkin2Structures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.PUMPKIN2_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
